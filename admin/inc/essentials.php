<?php 
    ...
    //backend uplaodd process needs this data
    ...
    // define('SENDGRID_API_KEY',"303a9d7afee7477841af2e089d1d6189");
    ...
    function uploadImage($image,$folder){
        ...
        if(!in_array($img_mime,$valid_mime)){
            ...
            // inavlid size greater than 2 mb
            return 'inv_size'; 
        }else{
    ...
    function uploadSVGImage($image,$folder){
        ...
        if(!in_array($img_mime,$valid_mime)){
            ...
            // inavlid size greater than 1 mb
            return 'inv_size'; 
        }else{
            $ext = pathinfo($image['name'],PATHINFO_EXTENSION);
            $rname = 'IMG_'.random_int(11111,99999).".$ext";
