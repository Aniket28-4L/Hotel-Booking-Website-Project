    ...
    if(isset($_POST['get_features'])){
        ...
        while($row = mysqli_fetch_assoc($res)){
            ...
            <tr>
                <td>$i</td>
                <td>$row[name]</td>
                <td><button type="type" onclick="rem_feature($row[id])" class="btn btn-danger btn-sm shadow-none">
    ...
    if(isset($_POST['get_facilities'])){
        ...
        while($row = mysqli_fetch_assoc($res)){
            ...
            <tr class='align-middle'>
                ...
                <td><button type="type" onclick="rem_facility($row[id])" class="btn btn-danger btn-sm shadow-none">
                    <i class="bi bi-trash"></i> Delete
                    </button>
                </td>
            </tr>
