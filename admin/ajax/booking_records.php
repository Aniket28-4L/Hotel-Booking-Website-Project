    ...
    if(isset($_POST['get_bookings'])){
        ...
        if($total_rows>$limit){
            ...
            if($page!=1){
                ...
                <button onclick='change_prev(1)' class='page-link shadow-none'>First</button></li>";
            ...
            $prev = $page-1;
            $pagination .="<li class='page-item $disabled'><button onclick='change_prev($prev)' class='page-link shadow-none'>Prev</button></li>";



            $disabled = ($page==$total_pages) ? "disabled" : "";
            $next=$page+1;
            $pagination .="<li class='page-item $disabled'><button onclick='change_prev($next)' class='page-link shadow-none'>Next</button></li>";


            if($page!=$total_pages){
                $pagination .="<li class='page-item'>
                <button onclick='change_prev($total_pages)' class='page-link shadow-none'>Last</button></li>";
