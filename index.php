...
<!-- testimonials starts here -->
    ...
    <?php 
      ...
      if(mysqli_num_rows($review_res)==0){
        ...
        while($row = mysqli_fetch_assoc($review_res)){
            $stars = "<i class='bi bi-start-fill text-warning'></i>";
            ...
            <div class="swiper-slide bg-white p-4">
                ...
                <p>
                $row[review]
                My recent stay at AS HOTEL was absolutely delightful! The impeccable service, elegant room, and convenient location made it an unforgettable experience. Highly recommend for your next trip!</p>
    ...
    ?>
      ...
      <div class="swiper-slide bg-white p-4">
        <div class="profile d-flex align-items-center mb-3">
            <img src="images/facilities/wifi.svg" width="30px">
            <h6 class="m-0 ms-2">Rajveer</h6>
        </div>
        <p>
        I recently stayed at AS HOTEL and was thoroughly impressed. The staff were incredibly friendly and attentive, the room was spacious and comfortable, and the location was perfect for exploring the city. Highly recommended!</p>
            <div class="rating"></div>
            <i class="bi bi-star-fill text-warning"></i>
            <i class="bi bi-star-fill text-warning"></i>
            <i class="bi bi-star-fill text-warning"></i>
      ...
      <div class="swiper-slide bg-white p-4">
        ...
        <p>
        Just had a fantastic stay at AS HOTEL! The room was spotless, the staff were so welcoming and helpful, and the breakfast was delicious. Highly recommend this hotel for anyone visiting</p>
            <div class="rating"></div>
            <i class="bi bi-star-fill text-warning"></i>
            <i class="bi bi-star-fill text-warning"></i>
            <i class="bi bi-star-fill text-warning"></i>
